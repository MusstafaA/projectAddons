...
//     // removed.
//
//       module.KitchenButtonWidget = module.PosBaseWidget.extend({
//       template: 'KitchenButtonWidget',
//             init: function(parent, options){
//                 this._super(parent, options);
...
//
//                 var self = this;
//        var currentOrder1=self.pos.get('selectedOrder');
//                 this._super();
//
//                 this.$el.click(function(){
//
//           console.warn('Kitchen Order Submitted...');
//          self.pos.push_order(currentOrder1.exportAsJSON())
//                 });
//             },
//         });
//
