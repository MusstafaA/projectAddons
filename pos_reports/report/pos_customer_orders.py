...
class order_inherit(report_sxw.rml_parse):
...
class report_order_receipt(osv.AbstractModel):
	_name = 'report.pos_reports.order_customer_orders'
	_inherit = 'report.abstract_report'
	_template = 'pos_reports.order_customer_orders'
	_wrapped_report_class = order_inherit