                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="order in control.orders">
                              ...
                              <td>
                              <button type="button" ng-click="control.editStage(order.me['struct']['id'].me['int'],order.me['struct']['stage'].me['string'])" class="btn btn-success custom-width">{{order.me['struct']['stage'].me['string']}}</button>
                          	  </td>
                          </tr>
                      </tbody>
                  </table>
